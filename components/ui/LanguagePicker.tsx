...
export function LanguagePicker() {
  ...
  // Додамо таку ж анімацію появи, як у меню
  useEffect(() => {
  ...
  return (
    <div ref={pickerRef} className="fixed top-8 right-8 z-101">
      <div className="relative bg-[#13131a]/80 backdrop-blur-xl border border-white/10 rounded-2xl p-1 shadow-2xl shadow-indigo-500/10 group cursor-pointer" onClick={toggleLanguage}>
        ...
        <div className="relative z-10 flex items-center justify-center gap-2 px-4 py-2 rounded-xl transition-all duration-300 group-hover:bg-white/5">
          <Languages size={18} className="text-gray-400 group-hover:text-indigo-400 transition-colors duration-300" />

...
export function Footer() {
  ...
  return (
    <footer className="py-12 bg-white/5 border-t border-white/10 relative backdrop-blur-sm">
          ...
          <div className="flex flex-col items-start gap-4 text-center">
            <p className="text-gray-400 flex flex-wrap items-center justify-center gap-1.5 text-sm md:text-base">
              ...
              <span className="flex items-center gap-1.5">
                {t("text1")}
                <span className="text-white hover:text-indigo-400 transition-colors cursor-default">
                  Next.js
                </span>
                <span className="text-gray-600">&</span>
                <span className="text-white hover:text-green-400 transition-colors cursor-default">
                  GSAP
                </span>
              </span>
            </p>
            ...
            <p className="flex items-center gap-2 text-xs uppercase tracking-[0.2em] text-gray-500">
              ...
              <span>{t("text3")}</span>
              <span className="hover:rotate-12 transition-transform cursor-default text-amber-600">
                ☕
              </span>
            </p>
          </div>
